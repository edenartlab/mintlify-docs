...
<img src="/img/flux_lora/selector.jpg" alt="Old SDXL trainer (left) and new FLUX trainer (right)" style={{width: '50%', margin: '0 auto'}} />
...
<Tabs>
  <Tab title="Face Mode">
    The **face** mode in the trainer will focus on the face only and try to ignore clothing and surroundings as much as possible, ideal for training a person:
    
    <img src="/img/flux_lora/xander_train.jpg" alt="Person training images. Notice all images are diverse and high quality." />
    <img src="/img/flux_lora/xander_test.jpg" alt="AI generated images using custom model" />
  </Tab>
  
  <Tab title="Object Mode">
    ...
    <img src="/img/flux_lora/banny_train.jpg" alt="Character training images. Notice all images are diverse and high quality." style={{width: '70%', margin: '0 auto'}} />
    <img src="/img/flux_lora/banny_test.jpg" alt="AI generated images using custom model" />
  </Tab>
  
  <Tab title="Style Mode">
    Used to learn the general aesthetics of a set of images, perfect for artists with their own custom style.
  </Tab>
</Tabs>
