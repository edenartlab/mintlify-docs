...
<CardGroup cols={2}>
  ...
  <Card title="Advanced Creation" icon="wand-magic-sparkles" href="/guides/creation">
    Explore all creation tools and parameters
  </Card>
  
  <Card title="SDK Reference" icon="code" href="/guides/sdk">
    Deep dive into the Eden SDK capabilities
  </Card>
...
- [API Documentation](https://api.eden.art/documentation) - Full API reference
