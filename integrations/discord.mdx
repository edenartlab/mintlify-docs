...
<Steps>
  ...
  <Step title="Link Bot to Eden Agent">
    ...
    You need to set up specific channels that your bot is allowed to access. The 'Allowed Channels' field is a list of channels your agent will be able to read and post to, and 'Read Access' is a list of channels your agent will be able to read from (but not post to).

    The note field is a description of the channel that would be helpful for you to give to your agent to tell it where to read or post. A good note is something like "AI Server - General Chat", "Company Server - Marketing Channel", etc.

    <img src="/img/discord/discord3.jpg" alt="Discord deployment channels" style={{width: '80%'}} />
    
    To find the channel IDs, first, enable Developer Mode in Discord:
...
<img src="/img/discord/discord4.jpg" alt="Discord tools" style={{width: '80%'}} />
